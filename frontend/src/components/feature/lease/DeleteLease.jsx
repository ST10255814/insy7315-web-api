            ...
            <div className="bg-white rounded-2xl shadow-lg border border-white/20 p-6">
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent focus:outline-none transition-all"
                  autoComplete="off"
                />
              </div>
