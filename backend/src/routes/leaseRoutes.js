...
router.post('/create', csrfProtection, leaseController.createLease);
router.get('/:leaseId', leaseController.getLeaseById);
router.delete('/:leaseId', csrfProtection, leaseController.deleteLease);

// Lease status management routes
router.patch('/update-statuses', csrfProtection, leaseController.updateLeaseStatuses);
router.patch('/global-status-update', csrfProtection, leaseController.triggerGlobalStatusUpdate);
