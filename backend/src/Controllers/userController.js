...
import { asyncHandler, validateRequiredFields, logControllerAction } from '../utils/controllerHelpers.js';
...
export const register = asyncHandler(async (req, res) => {
    ...
    validateRequiredFields(req.body, ['email', 'password', 'username', 'fullname']);
...
export const login = asyncHandler(async (req, res) => {
    ...
    // Log activity
    logControllerAction('User Login', result.user._id, { email: result.user.email });
...
export const resetPassword = asyncHandler(async (req, res) => {
    ...
    // Log activity
    logControllerAction('Password Reset Request', null, { email: req.body.email });
